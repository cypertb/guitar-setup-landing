...
Add your photos to this folder using these exact filenames. The live site will
automatically show each photo after you commit and push it to GitHub.

| Filename | Used for |
| --- | --- |
| `drew.jpg` | Drew's team photo |
| `bradley.jpg` | Bradley's team photo |
